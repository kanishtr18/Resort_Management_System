...
public class MenuController {
    ...
    public ResponseEntity<List<MenuResponse>> getAll(
        ...
        return ResponseEntity.ok(activeOnly ? menuService.findAllActive() : menuService.findAll());
    }
    ...
    public ResponseEntity<MenuResponse> create(
            @jakarta.validation.Valid @RequestBody MenuRequest request) {
        return new ResponseEntity<>(menuService.create(request), HttpStatus.CREATED);
    }
